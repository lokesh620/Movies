...
import { fetchAsyncMovieOrShowsDetail, getSelectedMovieOrShows, removeSelectorMovieOrShows } from '../../features/movies/movieSlice';
...
const MovieDetail = () => {
    ...
    useEffect(() => {
        ...
        return () => {
            dispatch(removeSelectorMovieOrShows());
        };
    }, [dispatch, imdbID])
